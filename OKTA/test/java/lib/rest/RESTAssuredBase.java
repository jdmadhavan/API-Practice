...
public class RESTAssuredBase extends PreAndTest{
	...
	public static Response postWithHeaderParamWithMultipart(String file,Map<String, String> headers, String URL) {

		return setLogs()
				.when()
				.headers(headers)
				.multiPart("_xsrfToken","6c9057b0b5e338854f64ca791bf67b1d7b5c72b136de398cda0daa773a0d1e0c")
				.multiPart("file",file)
				.multiPart("linkId", "2557")
				.post(URL);
	}
